...
const AD_HOST_PATTERN = /googlesyndication\.com|doubleclick\.net|googleadservices\.com|google\.com\/pagead|googletagservices\.com/;

export const test = base.extend<Fixtures>({
    pages: async ({ page }, use) => {
        await page.route(AD_HOST_PATTERN, (route) => route.abort());
